	...
	try {
     ...
     const time2 = moment().tz('Asia/Jakarta').format('HH:mm:ss')
       ...
       console.error(err)
		...
		const fakefoto = { key: {fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? {remoteJid: "status@broadcast"}: {})}, message: {imageMessage: {caption: `${ucapanWaktu}`, jpegThumbnail: thumbnail}}}
	    const fakevideo = { key: {fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? {remoteJid: "status@broadcast"}: {})}, message: {videoMessage: {caption: `${ucapanWaktu}`, jpegThumbnail: thumbnail}}}
...
case 'linkgc':
      ...
      case 'demote':
       ...
       case 'afk': 
              if (!isGroup) return reply(mess.only.group)
              if (isAfkOn) return reply('Kamu sedang afk, jangan kirim chat!')
